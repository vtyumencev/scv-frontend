...
const props = defineProps({
    items: { type: Array<Video>, default: [] },
    choirID: { type: Number, default: null }
})
...
<template>
    <div class="grid grid-cols-3 gap-5">
        <div v-for="item in items" class="relative max-w-sm bg-white border border-gray-200 rounded-lg shadow">
            <div class="relative">
    ...
    <div class="mt-5">
        ...
        <form @submit.prevent="submitVideo" class="grid grid-flow-col gap-2 grid-cols-[1fr_auto] mt-1">
            <div class="relative">
            ...
            <PrimaryButton type="submit" buttonStyle="outline" :processing="newVideoProcessing">Add video</PrimaryButton>
        </form>
