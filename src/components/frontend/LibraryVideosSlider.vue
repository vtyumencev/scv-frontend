...
<template>
    <div v-if="videos.length" class="relative">
        <button ref="buttonPrev" class="absolute left-[-60px] w-[40px] flex h-full items-center swiper-button-prev opacity-30 transition" @click="controlledSwiper.slidePrev()">
